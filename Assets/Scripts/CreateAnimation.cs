...
public class CreateAnimation : MonoBehaviour 
{
	...
	private int _numberOfFrames = 335;
	...
	{
		GameObject avatarPrefab = Resources.Load<GameObject> ("Prefabs/BaseAvatarPrefab");
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////0.2691084, 0.00679367, -0.006026763
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	private void SaveAnimatableAvatar()
	{
		AssetDatabase.CreateAsset(_clip, "Assets/Resources/Animation.anim");
		Material avatarMaterial = Resources.Load<Material> ("AvatarMaterial");
		_avatarTransform.GetComponentInChildren<Renderer> ().material = avatarMaterial;
		PrefabUtility.CreatePrefab ("Assets/Resources/Prefabs/AnimatableAvatarPrefab.prefab", _avatarTransform.gameObject);
		GameObject.Destroy (_avatarTransform.gameObject);
	}
}
